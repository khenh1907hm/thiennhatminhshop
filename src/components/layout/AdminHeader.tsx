      ...
      <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6 justify-between items-center">
        <form className="relative flex flex-1 max-w-md" action="#" method="GET">
          ...
          <div className="relative w-full">
            <span className="material-symbols-outlined pointer-events-none absolute inset-y-0 left-0 h-full w-5 text-outline flex items-center justify-center ml-3">
              search
            </span>
            <input
              id="search-field"
              className="block h-full w-full border-0 py-0 pl-10 pr-0 text-on-surface placeholder:text-outline focus:ring-0 sm:text-sm bg-surface-container-low rounded-xl px-4 my-2 transition-colors focus:bg-surface focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-primary"
